...
public class GeneracionAleatoria : MonoBehaviour
{
    ...
    void Awake()
    {
        // Puedes dejar este bloque vac�o si no quieres que se generen animales autom�ticamente al inicio
    }
    ...
    void Update()
    {
        // Dejar vac�o si no hay necesidad de actualizar cada frame
    }
}
